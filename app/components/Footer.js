      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex space-x-4">
            {/* Facebook Icon */}
            <button 
              onClick={() => openSocial('fb')}
              className="p-2 bg-blue-100 hover:bg-blue-200 text-blue-600 border border-blue-200 transition-colors"
            >
            ...
            <button 
              ...
              className="p-2 bg-green-100 hover:bg-green-200 text-green-600 border border-green-200 transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
